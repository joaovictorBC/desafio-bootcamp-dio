...
public class Dev {
    private String nome;
    //Foi utilizado o Linked, pois é guardado na memória os itens colocados e na ordem.E o Set pois ele obriga que só pode adicionar somente um curso e um conteudo, sem repetições
    ...
    public void progredir(){
        //pegar o primeiro conteudo
        Optional<Conteudos> conteudo = this.conteudosInscritos.stream().findFirst();
        if(conteudo.isPresent()) {
            this.conteudosConcluidos.add(conteudo.get());
            this.conteudosInscritos.remove(conteudo.get());
        } else {
            System.err.println("Você não está matrivulado em nenhum conteúdo!");
        }
    }
